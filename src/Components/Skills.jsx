      ...
      <div className="px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-4 gap-6 max-sm:grid-cols-1">
          <div
            ...
            className=" rounded-lg border bg-white border-gray-300 shadow-2xs hover:shadow-xl  transition delay-150 duration-600 ease-in-out hover:-translate-y-1 hover:scale-105"
          >
