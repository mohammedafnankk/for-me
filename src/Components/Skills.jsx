    ...
    <section className="py-20 dark:bg-bc bg-white" id="skills">
      <div className="px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-4 gap-6 ">
            ...
            <div data-aos="fade-up" data-aos-duration="800" className=" rounded-lg border bg-white border-gray-300 shadow-2xs hover:shadow-xl  transition delay-150 duration-600 ease-in-out hover:-translate-y-1 hover:scale-105">
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className=" rounded-lg border bg-white border-gray-300 shadow-2xs hover:shadow-xl  transition delay-150 duration-600 ease-in-out hover:-translate-y-1 hover:scale-105">
              <div className="p-6 flex flex-col text-center">
            ...
            <div data-aos="fade-up" data-aos-duration="2000" className=" rounded-lg border bg-white border-gray-300 shadow-2xs hover:shadow-xl  transition delay-150 duration-600 ease-in-out hover:-translate-y-1 hover:scale-105">
              <div className="p-6 flex flex-col text-center">
                <div className="transition-transform duration-500 hover:rotate-360">
                  {" "}
            ...
            <div data-aos="fade-up" data-aos-duration="3000" className=" rounded-lg border bg-white border-gray-300 shadow-2xs hover:shadow-xl  transition delay-150 duration-600 ease-in-out hover:-translate-y-1 hover:scale-105">
              <div className="p-6 flex flex-col text-center">
                <div className="transition-transform duration-500 hover:rotate-360">
                  {" "}
